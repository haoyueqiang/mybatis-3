 ...
 */
package org.apache.ibatis.a2_核心处理层.scripting_SQL解析.defaults;
...
class DefaultParameterHandlerTest {
  ...
  void setParametersThrowsProperException() throws SQLException {
    ...
    DefaultParameterHandler
            defaultParameterHandler = new DefaultParameterHandler(mappedStatement, parameterObject, boundSql);
