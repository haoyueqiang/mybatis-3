 ...
 */
package org.apache.ibatis.a2_核心处理层.builder.xsd;

import org.apache.ibatis.a2_核心处理层.builder.CustomLongTypeHandler;
import org.apache.ibatis.a2_核心处理层.builder.CustomObjectWrapperFactory;
import org.apache.ibatis.a2_核心处理层.builder.CustomReflectorFactory;
import org.apache.ibatis.a2_核心处理层.builder.CustomStringTypeHandler;
import org.apache.ibatis.a2_核心处理层.builder.ExampleObjectFactory;
import org.apache.ibatis.a2_核心处理层.builder.ExamplePlugin;
import org.apache.ibatis.a2_核心处理层.builder.mapper.CustomMapper;
import org.apache.ibatis.a2_核心处理层.builder.typehandler.CustomIntegerTypeHandler;
...
class XmlConfigBuilderTest {
  ...
  void shouldSuccessfullyLoadMinimalXMLConfigFile() throws Exception {
    ...
    String resource = "org/apache/ibatis/a2_核心处理层/builder/xsd/MinimalMapperConfig.xml";
  ...
  void shouldSuccessfullyLoadXMLConfigFitle() throws Exception {
    // System.setProperty(XPathParser.KEY_USE_XSD, "true");
    String resource = "org/apache/ibatis/a2_核心处理层/builder/xsd/CustomizedSettingsMapperConfig.xml";
    try (InputStream inputStream = Resources.getResourceAsStream(resource)) {
      XMLConfigBuilder builder = new XMLConfigBuilder(inputStream);
      Configuration config = builder.parse();
