 ...
 */
package org.apache.ibatis.a2_核心处理层.builder_配置解析过程.xsd;

import org.apache.ibatis.a2_核心处理层.builder_配置解析过程.CustomLongTypeHandler;
import org.apache.ibatis.a2_核心处理层.builder_配置解析过程.CustomObjectWrapperFactory;
import org.apache.ibatis.a2_核心处理层.builder_配置解析过程.CustomReflectorFactory;
import org.apache.ibatis.a2_核心处理层.builder_配置解析过程.CustomStringTypeHandler;
import org.apache.ibatis.a2_核心处理层.builder_配置解析过程.ExampleObjectFactory;
import org.apache.ibatis.a2_核心处理层.builder_配置解析过程.ExamplePlugin;
import org.apache.ibatis.a2_核心处理层.builder_配置解析过程.mapper.CustomMapper;
import org.apache.ibatis.a2_核心处理层.builder_配置解析过程.typehandler.CustomIntegerTypeHandler;
...
class XmlConfigBuilderTest {
  ...
  void shouldSuccessfullyLoadMinimalXMLConfigFile() throws Exception {
    ...
    String resource = "org/apache/ibatis/a2_核心处理层/builder_配置解析过程/xsd/MinimalMapperConfig.xml";
  ...
  void shouldSuccessfullyLoadXMLConfigFitle() throws Exception {
    // System.setProperty(XPathParser.KEY_USE_XSD, "true");
    String resource = "org/apache/ibatis/a2_核心处理层/builder_配置解析过程/xsd/CustomizedSettingsMapperConfig.xml";
    try (InputStream inputStream = Resources.getResourceAsStream(resource)) {
      XMLConfigBuilder builder = new XMLConfigBuilder(inputStream);
      Configuration config = builder.parse();
