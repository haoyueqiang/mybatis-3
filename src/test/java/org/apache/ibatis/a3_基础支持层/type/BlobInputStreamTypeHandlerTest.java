 ...
 */
package org.apache.ibatis.a3_基础支持层.type;
...
class BlobInputStreamTypeHandlerTest extends BaseTypeHandlerTest {
  ...
  static void setupSqlSessionFactory() throws Exception {
    DataSource dataSource = BaseDataTest.createUnpooledDataSource(
      "org/apache/ibatis/a3_基础支持层/type/jdbc.properties");
    ...
    BaseDataTest.runScript(sqlSessionFactory.getConfiguration().getEnvironment().getDataSource(),
      "org/apache/ibatis/a3_基础支持层/type/BlobInputStreamTypeHandlerTest.sql");
  }
