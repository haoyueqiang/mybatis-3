...
import org.apache.ibatis.executor_SQL执行_执行器.BatchExecutor;
import org.apache.ibatis.executor_SQL执行_执行器.CachingExecutor;
import org.apache.ibatis.executor_SQL执行_执行器.Executor;
import org.apache.ibatis.executor_SQL执行_执行器.ReuseExecutor;
import org.apache.ibatis.executor_SQL执行_执行器.SimpleExecutor;
...
import org.apache.ibatis.executor_SQL执行_执行器.resultset.ResultSetHandler;
import org.apache.ibatis.executor_SQL执行_执行器.statement.RoutingStatementHandler;
import org.apache.ibatis.executor_SQL执行_执行器.statement.StatementHandler;
